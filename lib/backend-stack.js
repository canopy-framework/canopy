...
class VectorAwsStack extends Stack {
  constructor(scope, id, props) {
    ...
    // assignPublicIP must be true when fetching public image from Docker Hub
    const vectorService = new ecs.FargateService(
      this, 'vector-service', {
        serviceName: 'vector',
        cluster: CLUSTER,
        cloudMapOptions: {
    ...
    fileSystem.connections.allowDefaultPortFrom(vectorService.connections);
  }
}
